      ...
      <div className="row mb-4">
        ...
        <div className="col-lg-5">
          <div className="d-flex flex-column h-100">
            <h2 className="mb-1">softdev iPhone X cover</h2>
            ...
            <dl className="row">
              ...
              <dd className="col-sm-8 mb-3">softdev</dd>
            ...
            <p className="lead flex-shrink-0">
              <small>
                ...
                reserved volume. The release of self, the flavor of
